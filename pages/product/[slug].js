        ...
        <div className="flex flex-col lg:flex-row md:px-10 gap-[50px] lg:gap-[100px]">
          ...
          <div className="flex-[1] py-3">
            ...
            <div className="flex items-center">
              <p className="mr-2 text-lg font-semibold">MRP : &#8377;Rs 5000</p>
              {/* {p.original_price && (
                                <>
            ...
            <div className="mb-10">
              ...
              <div id="sizesGrid" className="grid grid-cols-3 gap-2">
                <div
                  className={`border rounded-md text-center py-3 hover:border-black font-medium `}
                >
                  UK 6
                </div>
                <div
            ...
            <div>
              ...
              <div className="markdown text-md mb-5">
                ...
                and climate conditions, it is vulnerable, and shoes provide
                ...
                equipment, such as steel-toe boots, which are required footwear
